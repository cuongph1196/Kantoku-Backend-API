    ...
    public class PermissionAttribute : Attribute, IAuthorizationFilter
    {
        ...
        public async void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            else
            {
                ...
                //if (context.HttpContext.Session.GetString(SystemConstants.UserSession) != null)
                //{
                //    user = JsonConvert.DeserializeObject<LoggedInUser>(context.HttpContext.Session.GetString(SystemConstants.UserSession));
                //}
                //else
                //{
                //    user = (LoggedInUser)context.HttpContext.Items["UserLogin"];
                //}
                if (user == null)
                {
        ...
        public static bool IsAuthorizedUser(AuthorizationFilterContext context)
        {
            try
            {
                return context.HttpContext.Session.GetString(SystemConstants.UserSession) != null;
            }
