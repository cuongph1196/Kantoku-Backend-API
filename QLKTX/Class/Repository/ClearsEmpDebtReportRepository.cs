...
{
    public interface IClearsEmpDebtReportRepository
    {
    ...
    public class ClearsEmpDebtReportRepository : IClearsEmpDebtReportRepository
    {
        private readonly string _connectionString;
        private readonly ConnectionStrings _connectionStrings;

        public ClearsEmpDebtReportRepository(IConfiguration configuration, IOptions<ConnectionStrings> connectionStrings)
        {
        ...
        public DataTablePagingResultVm<dynamic> SearchPaging(SummaryVoucherRSearchPagingVm vm)
        {
            ...
            var result = new StoredProcedureFactory<dynamic>(_connectionString).FindAllBy(masterParams,
                "sprpt_ClearsEmpDebtReport", "SearchPaging");
        ...
        public dynamic SearchReport(SummaryVoucherRSearchVm vm)
        {
            ...
            var result = new StoredProcedureFactory<dynamic>(_connectionString).GetDataTable(arrParams,
                "sprpt_ClearsEmpDebtReport", "GetVoucherDetail");
            return result;
        }
    }
}
