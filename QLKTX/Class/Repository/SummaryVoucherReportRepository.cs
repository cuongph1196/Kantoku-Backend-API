...
{
    public interface ISummaryVoucherReportRepository
    {
    ...
    public class SummaryVoucherReportRepository : ISummaryVoucherReportRepository
    {
        private readonly string _connectionString;
        private readonly ConnectionStrings _connectionStrings;

        public SummaryVoucherReportRepository(IConfiguration configuration, IOptions<ConnectionStrings> connectionStrings)
        {
        ...
        public DataTablePagingResultVm<dynamic> SearchPaging(SummaryVoucherRSearchPagingVm vm)
        {
            ...
            var result = new StoredProcedureFactory<dynamic>(_connectionString).FindAllBy(masterParams,
                "sprpt_SummaryVoucherReport", "SearchPaging");
        ...
        public dynamic SearchReport(SummaryVoucherRSearchVm vm)
        {
            ...
            var result = new StoredProcedureFactory<dynamic>(_connectionString).GetDataTable(arrParams,
                "sprpt_SummaryVoucherReport", "GetSummaryVoucher");
            return result;
        }
    }
}
