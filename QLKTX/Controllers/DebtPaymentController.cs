...
namespace QLKTX.Controllers
{
    ...
    public class DebtPaymentController : BaseController
    {
        ...
        private readonly ILogger<DebtPaymentController> _logger;
        ...
        public DebtPaymentController(ILogger<DebtPaymentController> logger,
            IMemoryCache cache,
        ...
        [Route("DebtPaymentEntry")]
        [HttpGet]
        public IActionResult DebtPaymentEntry(int ModuleID, int FunctionID, string TransID)
        {
            var funcS = HttpContext.Session.GetString(SystemConstants.FunctionMenuSession + "_" + ModuleID);
            var funcMenu = new List<FunctionMenuVm>();
            if (funcS != null)
