...
{
    [Route("ApprovedContract")]
    [ApiController]
    [Authorize]
    public class ApprovedContractController : BaseController
    {
        public static IWebHostEnvironment _environment;
        private readonly ILogger<ApprovedContractController> _logger;
        private readonly IContractRepository _contractRepository;
        private readonly IFileUploadRepository _fileUploadRepository;
        private readonly IUploadFileService _uploadFileService;
        private IMemoryCache _cache;
        private readonly string _transID = "CONTRACT";
        public ApprovedContractController(ILogger<ApprovedContractController> logger,
            IMemoryCache cache,
        ...
        [Route("ApprovedContractEntry")]
        [HttpGet]
        public IActionResult ApprovedContractEntry(int ModuleID, int FunctionID)
        {
            var funcS = HttpContext.Session.GetString(SystemConstants.FunctionMenuSession + "_" + ModuleID);
            var funcMenu = new List<FunctionMenuVm>();
            if (funcS != null)
        ...
        {
            return ViewComponent("UploadDocuments", new { transID = _transID, masterkey, detaiKey });
        }
