...
{
    [Route("PosVoucherReceipts")]
    [ApiController]
    [Authorize]
    public class PosVoucherReceiptsController : BaseController
    {
        ...
        public PosVoucherReceiptsController(ILogger<VoucherReceiptsController> logger,
            IMemoryCache cache,
        ...
        [Route("PosVoucherReceiptsEntry")]
        [HttpGet]
        public IActionResult PosVoucherReceiptsEntry(int ModuleID, int FunctionID, string TransID)
        {
            var funcS = HttpContext.Session.GetString(SystemConstants.FunctionMenuSession + "_" + ModuleID);
            var funcMenu = new List<FunctionMenuVm>();
            if (funcS != null)
