...
{
    [Route("ContractStatisticsReport")]
    [ApiController]
    [Authorize]
    public class ContractStatisticsReportController : BaseController
    {
        public static IWebHostEnvironment _environment;
        private readonly ILogger<ContractStatisticsReportController> _logger;
        private readonly IContractStatisticsReportRepository _vdrRepository;
        private IMemoryCache _cache;
        public ContractStatisticsReportController(ILogger<ContractStatisticsReportController> logger,
            IMemoryCache cache,
            IContractStatisticsReportRepository vdrRepository,
        ...
        {
            string reportname = $"ThongKeHopDong_{Guid.NewGuid():N}.xlsx";
        ...
        private byte[] ExporttoExcel<T>(List<IDictionary<string, object>> data, string filename)
        {
            ...
            using (ExcelRange Rng = ws.Cells[ws.Dimension.Address])
            {
                ...
                ExcelTable table = tblcollection.Add(Rng, "ThongKeHopDong");
