...
{
    [Route("ContractStatisticsReasonReport")]
    [ApiController]
    [Authorize]
    public class ContractStatisticsReasonReportController : BaseController
    {
        public static IWebHostEnvironment _environment;
        private readonly ILogger<ContractStatisticsReasonReportController> _logger;
        private readonly IContractStatisticsReasonReportRepository _vdrRepository;
        private IMemoryCache _cache;
        public ContractStatisticsReasonReportController(ILogger<ContractStatisticsReasonReportController> logger,
            IMemoryCache cache,
            IContractStatisticsReasonReportRepository vdrRepository,
        ...
        {
            string reportname = $"ThongKeHDTheoKhoanMuc_{Guid.NewGuid():N}.xlsx";
        ...
        private byte[] ExporttoExcel<T>(List<IDictionary<string, object>> data, string filename)
        {
            ...
            using (ExcelRange Rng = ws.Cells[ws.Dimension.Address])
            {
                ...
                ExcelTable table = tblcollection.Add(Rng, "ThongKeHDTheoKhoanMuc");
