...
{
    [Route("VoucherPayments")]
    [ApiController]
    [Authorize]
    public class VoucherPaymentsController : BaseController
    {
        public static IWebHostEnvironment _environment;
        private readonly ILogger<VoucherPaymentsController> _logger;
        ...
        public VoucherPaymentsController(ILogger<VoucherPaymentsController> logger,
            IMemoryCache cache,
        ...
        [Route("VoucherPaymentsEntry")]
        [HttpGet]
        public IActionResult VoucherPaymentsEntry(int ModuleID, int FunctionID, string TransID)
        {
            var funcS = HttpContext.Session.GetString(SystemConstants.FunctionMenuSession + "_" + ModuleID);
            var funcMenu = new List<FunctionMenuVm>();
            if (funcS != null)
