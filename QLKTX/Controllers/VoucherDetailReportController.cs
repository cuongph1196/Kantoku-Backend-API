...
{
    [Route("VoucherDetailReport")]
    [ApiController]
    [Authorize]
    public class VoucherDetailReportController : BaseController
    {
        public static IWebHostEnvironment _environment;
        private readonly ILogger<VoucherDetailReportController> _logger;
        private readonly IVoucherDetailReportRepository _vdrRepository;
        private IMemoryCache _cache;
        public VoucherDetailReportController(ILogger<VoucherDetailReportController> logger,
            IMemoryCache cache,
            IVoucherDetailReportRepository vdrRepository,
