...
{
    [Route("ContractDetailReport")]
    [ApiController]
    [Authorize]
    public class ContractDetailReportController : BaseController
    {
        public static IWebHostEnvironment _environment;
        private readonly ILogger<ContractDetailReportController> _logger;
        private readonly IContractDetailReportRepository _vdrRepository;
        private IMemoryCache _cache;
        public ContractDetailReportController(ILogger<ContractDetailReportController> logger,
            IMemoryCache cache,
            IContractDetailReportRepository vdrRepository,
        ...
        {
            string reportname = $"BaoCaoChiTietHD_{Guid.NewGuid():N}.xlsx";
        ...
        private byte[] ExporttoExcel<T>(List<IDictionary<string, object>> data, string filename)
        {
            ...
            using (ExcelRange Rng = ws.Cells[ws.Dimension.Address])
            {
                ...
                ExcelTable table = tblcollection.Add(Rng, "ABC");
