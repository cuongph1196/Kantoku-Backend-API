...
{
    [Route("VoucherReceipts")]
    [ApiController]
    [Authorize]
    public class VoucherReceiptsController : BaseController
    {
        public static IWebHostEnvironment _environment;
        private readonly ILogger<VoucherReceiptsController> _logger;
        ...
        public VoucherReceiptsController(ILogger<VoucherReceiptsController> logger,
            IMemoryCache cache,
        ...
        [Route("VoucherReceiptsEntry")]
        [HttpGet]
        public IActionResult VoucherReceiptsEntry(int ModuleID, int FunctionID, string TransID)
        {
            var funcS = HttpContext.Session.GetString(SystemConstants.FunctionMenuSession + "_" + ModuleID);
            var funcMenu = new List<FunctionMenuVm>();
            if (funcS != null)
        ...
        [Route("PrintVoucher")]
        [HttpGet]
        public IActionResult PrintVoucher(int ModuleID, int FunctionID, int VoucherKey)
        {
        ...
        [Route("GetCreateByContract")]
        [HttpGet]
        [Permission(Action = "FView")]
        public IActionResult GetCreateByContract([FromQuery] string rowKeyLst)
        {
            var result = _voucherRepository.GetCreateByContract(rowKeyLst);
            return Ok(result);
        }
