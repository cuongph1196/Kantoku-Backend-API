...
namespace QLKTX.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class VoucherEPTMController : BaseController
    {
        public static IWebHostEnvironment _environment;
        private readonly ILogger<VoucherEPTMController> _logger;
        ...
        public VoucherEPTMController(ILogger<VoucherEPTMController> logger,
            IMemoryCache cache,
        ...
        [Route("VEPTMEntry")]
        [HttpGet]
        public IActionResult VEPTMEntry(int ModuleID, int FunctionID, string TransID)
        {
            var funcS = HttpContext.Session.GetString(SystemConstants.FunctionMenuSession + "_" + ModuleID);
            var funcMenu = new List<FunctionMenuVm>();
            if (funcS != null)
        ...
        {
            var result = _voucherRepository.Approve(vm);
            return Ok(result);
        }
